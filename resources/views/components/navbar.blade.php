<!-- filepath: /D:/Laravel Herd/belajar_laravel/resources/views/components/navbar.blade.php -->
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-navlink href="/posts" :active="request()->is('posts')">My Blog</x-navlink>
                        <x-navlink href="/contact" :active="request()->is('contact')">My Contact</x-navlink>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Ken Dnov</div>
